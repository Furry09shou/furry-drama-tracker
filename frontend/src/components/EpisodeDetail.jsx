      ...
      <div className="episode-info">
        ...
        <div className="episode-details">
          ...
          <div className="meta-info">
            ...
            {user && isFollowing && (
              <p><strong>{t('episode.watchProgress')}</strong>{t('episode.watchedLabel')} {watchedEpisodes.length}/{episode.totalEpisodes === null ? '?' : episode.totalEpisodes} {t('episode.epSuffix')}</p>
            )}
          </div>
